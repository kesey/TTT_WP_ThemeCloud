<?php
/**
 * The template part for displaying live
 *
    ...
    <div class="live_container">
        <?php
            ...
            foreach ($child_posts as $child_post) {
                $post_id = (wpcf_pr_post_get_belongs($child_post->ID, 'artist')) ? wpcf_pr_post_get_belongs($child_post->ID, 'artist') : wpcf_pr_post_get_belongs($child_post->ID, 'event');
